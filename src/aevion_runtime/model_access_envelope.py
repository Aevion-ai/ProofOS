...
class AccessTier(str, Enum):
    ...
    def __ge__(self, other: AccessTier) -> bool:  # type: ignore[override]
        ...
        # ⚡ Bolt Optimization: Use module-level constant to prevent dict creation on every comparison
...
# ⚡ Bolt Optimization: Define access tier ordering outside methods for performance
_ACCESS_TIER_ORDER = {
    AccessTier.PUBLIC: 0,
