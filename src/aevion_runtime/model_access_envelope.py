...
class AccessTier(str, Enum):
    ...
    def __ge__(self, other: AccessTier) -> bool:  # type: ignore[override]
        ...
        # Optimized: Refers to module-level constant rather than recreating dict on every call
...
# Module-level constant to prevent dict instantiation on every AccessTier comparison
_ACCESS_TIER_ORDER = {
    AccessTier.PUBLIC: 0,
